...
public class Catfish extends Animal {
	...
	public static final double EGGS_FLOAT = .8; //about 10% of the time in the daylight, and children 60% of the time in the daylight
	public static final int MINAGE = 4;
	public static final int OLDAGE = 10;
	public static final double SOLO_PERC = .42;
	public static final double AVE_NUM_BABIES = 4.5;
	public int above;
	
	public Catfish(int x, int y)
	{
		super(x, y);
		above = 0;
		type = "Catfish";
		pic = new ImageIcon("CatfishEggs.png");
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////	
    ...
    public void move() 
    {
    	...
    	if(gender == 0 && Math.random() < EGGS_FLOAT) return;  
    	...
    	if(gender > 0) {
    		...
    		if(above > 0) {
    			if(gender == 1) {
    				pic = new ImageIcon("CatfishAdultMale.png");
    			}
    			else {
    				pic = new ImageIcon("CatfishAdultFemale.png");
    			}
    		}
    		else {
    			if(gender == 1) {
    				pic = new ImageIcon("CatfishAdultMaleUnder.png");
    			}
    			else {
    				pic = new ImageIcon("CatfishAdultFemaleUnder.png");
    			}
    		}
    		if(target != null && gender == 2) //moves towards baby
    		{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////    
    ...
    public void act() 
    {
    	...
    	for(int n = Control.bits.size()-1; n >= 0; n--)
    		if(Control.bits.get(n).food && reach.intersects(Control.bits.get(n).space) && health <= 200)
    		{
    			//Find food, eat food...
    			hungry = false;
        ...
        {
        	if(Control.critters.get(n).gender == 2 && !Control.critters.get(n).pregnant && checkIf(Control.critters.get(n), "Catfish", reach)) {
        		found = true;
        		foundn = n;
        ...
        if(found) { 
        	...
        	above += 10;
    		Control.critters.get(foundn).above += 10;
        }
    }
    ...
    public void age() 
    {
        ...
        while(morebabies)
        {
        	...
        	Animal baby = new Catfish(space.x+delx, space.y+dely);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public Rectangle lookAround()
    {
    	...
    	{
    		if(checkIf(Control.critters.get(n), "CatFish", view) && Control.critters.get(n).age == 0)
